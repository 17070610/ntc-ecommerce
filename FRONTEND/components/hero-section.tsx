                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        ...
                        <Link href="/shipping-info">
                            <div className="absolute -bottom-4 -left-4 bg-primary text-primary-foreground px-4 py-2 rounded-full text-sm font-medium shadow-lg cursor-pointer hover:bg-primary/90 transition-colors">
                                Free Shipping
                            </div>
                        </Link>
                    </div>
